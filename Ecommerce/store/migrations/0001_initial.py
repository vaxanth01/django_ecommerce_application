    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work', models.CharField(choices=[('P', 'Product'), ('S', 'Service')], default='Product', max_length=20)),
                ...
                ('uom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.unit_of_mesurement')),
            ],
            options={
